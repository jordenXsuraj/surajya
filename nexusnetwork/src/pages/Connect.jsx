...
export default function Connect() {
  ...
  useEffect(() => {
    ...
    axios.get(`${base}/notifications/unread-count`, { headers: h })
  ...
  useEffect(() => {
    ...
    if (tab === 'suggestions') {
      request = axios.get(`${base}/users/suggestions`, { headers:h, signal:controller.signal })
        .then(r => setSuggests(Array.isArray(r.data) ? r.data : []))
    }
    ...
    if (tab === 'requests') {
      ...
      Promise.all([
        axios.get(`${base}/users/requests`,    { headers: h }),
        axios.get(`${base}/notifications`,     { headers: h }),
      ])
  ...
  async function handleOpenNotifications() {
    ...
    if (unreadCount > 0) {
      try {
        await axios.put(`${base}/notifications/mark-read`, {}, { headers: h })
        setUnread(0)
